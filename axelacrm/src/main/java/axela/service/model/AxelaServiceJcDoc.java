...
/**
 * The persistent class for the axela_service_jc_docs database table.
 * 
 */
@Entity
@Table(name = "axela_service_jc_docs", catalog = "axela_1")
@NamedQuery(name = "AxelaServiceJcDoc.findAll", query = "SELECT a FROM AxelaServiceJcDoc a")
public class AxelaServiceJcDoc implements Serializable {
	...
	public int getDocJcId() {
		return this.docJcId;
	}

	public void setDocJcId(int docJcId) {
		this.docJcId = docJcId;
	}
