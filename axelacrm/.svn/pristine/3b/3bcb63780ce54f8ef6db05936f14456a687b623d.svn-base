...
var userAccessListComponent = (function () {
    function userAccessListComponent(router, http) {
        this.router = router;
        this.http = http;
    ...
    userAccessListComponent.prototype.ngOnInit = function () {
        //		this.smart.smartUrl = sessionStorage.getItem('requestUrl')+"/axelacrm/portal/activeuser-smartsearch";
        //  		this.list.listUrl=sessionStorage.getItem('requestUrl')+"/axelacrm/portal/active-user-list";
    };
    userAccessListComponent.prototype.ngAfterViewInit = function () {
    };
    userAccessListComponent.prototype.smartToggle = function () {
        if (this.smartHide) {
    ...
    userAccessListComponent.prototype.toggleAnimation = function () {
        this.router.navigate(['portal/executive-list'], { queryParams: { executiveId: this.executiveId } });
    };
    userAccessListComponent.prototype.listClickListener = function (listParam) {
        if (listParam[0] == 'executive summary') {
            this.executiveId = listParam[1];
            this.toggleAnimation();
        }
    };
    userAccessListComponent.prototype.smartClickListener = function (event) {
        this.list.listParam['requestType'] = 'filter';
        this.list.listParam['smartParam'] = event;
        this.list.getData();
    };
    return userAccessListComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('@flyInOutTrigger'),
    __metadata("design:type", Object)
], userAccessListComponent.prototype, "flyInOutTrigger", void 0);
__decorate([
...
], userAccessListComponent.prototype, "list", void 0);
__decorate([
...
], userAccessListComponent.prototype, "toast", void 0);
userAccessListComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: ".m-grid__item.m-grid__item--fluid.m-wrapper",
        template: __webpack_require__("../../../../../src/app/theme/pages/portal/user-access/user-access-list.component.html"),
...
var _a, _b, _c, _d;
//# sourceMappingURL=user-access-list.component.js.map

/***/ }),

/***/ "../../../../../src/app/theme/pages/portal/user-access/user-access-list.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "userAccessListModule", function() { return userAccessListModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_access_list_component__ = __webpack_require__("../../../../../src/app/theme/pages/portal/user-access/user-access-list.component.ts");
...
var routes = [
    {
        ...
        "children": [
            {
                "path": "",
                "component": __WEBPACK_IMPORTED_MODULE_3__user_access_list_component__["a" /* userAccessListComponent */]
            }
        ]
    }
];
var userAccessListModule = (function () {
    function userAccessListModule() {
    }
    return userAccessListModule;
}());
userAccessListModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [__WEBPACK_IMPORTED_MODULE_3__user_access_list_component__["a" /* userAccessListComponent */]],
    })
], userAccessListModule);

//# sourceMappingURL=user-access-list.module.js.map

/***/ })

});
//# sourceMappingURL=user-access-list.module.chunk.js.map