webpackJsonp(["man-hours.module"],{

/***/ "../../../../../src/app/theme/pages/service/man-hours/man-hours.component.html":
/***/ (function(module, exports) {

module.exports = "<toast></toast>\r\n<div class=\"m-subheader mr-auto\" >\r\n\t\r\n\t\t<h3 class=\"m-subheader__title m-subheader__title--separator\">\r\n\t\t\t\tMan Hours\r\n\t\t</h3>\r\n\t\t<ul class=\"m-subheader__breadcrumbs m-nav m-nav--inline\">\r\n\t\t\t\r\n\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t<a href=\"\" class=\"m-nav__link\">\r\n\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\tHome\r\n\t\t\t\t\t</span>\r\n\t\t\t\t</a>\r\n\t\t\t</li>\r\n\t\t\t<li class=\"m-nav__separator\">\r\n\t\t\t\t\t>\r\n\t\t\t\t</li>\r\n\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t<a routerLink=\"/service/service-dashboard\" class=\"m-nav__link\">\r\n\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\tService\r\n\t\t\t\t\t</span>\r\n\t\t\t\t</a>\r\n\t\t\t</li>\r\n\t\t\t<li class=\"m-nav__separator\">\r\n\t\t\t\t\t>\r\n\t\t\t\t</li>\r\n\t\t\t<li class=\"m-nav__item\" *ngIf=\"jcId!='0'\">\r\n\t\t\t\t<a href=\"service/jobcard-list\" class=\"m-nav__link\">\r\n\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t Job Card Dash: \r\n\t\t\t\t\t</span>\r\n\t\t\t\t</a>\r\n\t\t\t</li>\r\n\t\t\t<li class=\"m-nav__item\" *ngIf=\"jcId=='0'\">\r\n\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\tMan Hours:\r\n\t\t\t\t</span>\r\n\t\t\t</li>\r\n\t\t\t\r\n\t\t</ul>\r\n\t</div>\r\n\r\n\t<div class=\"m-portlet m-portlet--mobile\">\r\n\t\t\t\t<div class=\"m-portlet__head col-md-12 btn-row\" >\r\n\t\t\t\t\t<div class=\"m-portlet__head-caption\">\r\n\t\t\t\t\t\t<div class=\"m-portlet__head-title\">\r\n\t\t\t\t\t\t\t<h2 class=\"m-portlet__head-text\">\r\n\t\t\t\t\t\t\tMan Hours\r\n\t\t\t\t\t\t\t</h2>\r\n\t\t\t\t\t\t</div>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t<form (ngSubmit)=\"onSubmit()\" class=\"m-form m-form--fit m-form--label-align-right\" [formGroup]=\"manHoursForm\" id=\"m_form_1\">\r\n\t\t<div class=\"m-portlet__body row\">\r\n\t\t\t\r\n\t\t\t<div class='col-md-6' *ngIf=\"branchName==''\">\r\n\t\t\t\t<mat-form-field>\r\n\t\t\t\t <mat-select placeholder=\"Select Branch\" [(ngModel)]=\"manhours.bayBranchId\" formControlName=\"bayBranchId\" required>\r\n\t\t\t\t<mat-option *ngFor=\"let branch of branch\" [value]=\"branch.key\">\r\n\t\t\t\t{{branch.name}}\r\n\t\t\t\t</mat-option>\r\n\t\t\t\t</mat-select>\r\n\t\t\t\t <mat-error *ngIf=\"bayBranchId.hasError('required')\"> Select Branch </mat-error>\r\n\t\t\t\t</mat-form-field>\r\n\t\t\t</div>\r\n\t\t\t\r\n\t\t\t<div class='col-md-6' *ngIf=\"branchName!=''\" style=\"padding: 2em;\">\r\n\t\t\t<label>Branch :</label><a href=\"\"> {{branchName}}</a>\r\n\t\t\t</div>\r\n\t\t\t\r\n\t\t\t\r\n\t\t\t<div class='col-md-6'>\r\n\t\t\t\t<mat-form-field>\r\n\t\t\t\t <mat-select placeholder=\"Select Bay\" [(ngModel)]=\"manhours.baytransBayId\" formControlName=\"baytransBayId\" required>\r\n\t\t\t\t<mat-option *ngFor=\"let bay of bay\" [value]=\"bay.key\">\r\n\t\t\t\t{{bay.name}}\r\n\t\t\t\t</mat-option>\r\n\t\t\t\t</mat-select>\r\n\t\t\t\t  <mat-error *ngIf=\"baytransBayId.hasError('required')\"> Select Bay </mat-error>\r\n\t\t\t\t</mat-form-field>\r\n\t\t\t</div>\r\n\t\t\t\r\n\t\t\t<div class='col-md-6' *ngIf=\"jcId=='0'\">\r\n\t\t\t<mat-form-field>\r\n\t\t\t\t<input matInput placeholder=\"Job Card Id\" [(ngModel)]=\"manhours.baytransJcId\"  maxlength=\"6\" name=\"baytransJcId\" formControlName=\"baytransJcId\"  required>\r\n            <mat-error *ngIf=\"baytransJcId.hasError('required')\">  Enter Job Card Id</mat-error>\r\n             <mat-error *ngIf=\"baytransJcId.hasError('pattern')\">  Enter Valid Job Card Id</mat-error>\r\n             </mat-form-field>\r\n\t\t\t</div>\r\n\r\n\t\t\t<div class='col-md-6' *ngIf=\"jcId!='0'\">\r\n\t\t\t\t<div class='col-md-6' *ngIf=\"this.manhours.jcId!='0'\" style=\"padding-top: 2.19em\">\r\n\t\t\t\t\t<label>Job Card Id:</label> {{jcId}}\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\r\n\t\t\t<div class='col-md-6'>\r\n\t\t\t<mat-form-field>\r\n\t\t\t\t<input matInput placeholder=\"User Id\" [(ngModel)]=\"manhours.baytransEmpId\"  maxlength=\"6\" name=\"baytransEmpId\" formControlName=\"baytransEmpId\"   required>\r\n             <mat-error *ngIf=\"baytransEmpId.hasError('required')\"> Enter User Id</mat-error>\r\n             </mat-form-field>\r\n\t\t\t</div>\r\n\t\t\t\r\n\t\t\t <div class=\"col-md-12 btn-row\" >\r\n\t\t\t\t\t <button mat-button [disabled]=\"false\"  class=\"btn btn-primary\"> Start </button> \r\n\t\t\t\t\t <button mat-button [disabled]=\"false\"  class=\"btn btn-primary\"> Stop </button>\r\n\t\t\t </div>\r\n\t\t\r\n\t\t</div>\r\n\t</form>\r\n</div>\r\n"

/***/ }),

/***/ "../../../../../src/app/theme/pages/service/man-hours/man-hours.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ManHoursComponent; });
/* unused harmony export ManHoursData */
...
var NUM_REGAX = /[0-9]/;
var ManHoursComponent = (function () {
    function ManHoursComponent(_script, router, http, route) {
        var _this = this;
        ...
        this.msg = [];
        this.manhours = new ManHoursData();
        this.branch = [];
        this.bay = [];
        this.jcId = 0;
        //	baytransId:string;
        this.branchName = '';
        this.route.queryParams.filter(function (params) { return params.jcId; }).subscribe(function (params) {
            if ((params.jcId != undefined) && (params.jcId != '0')) {
                _this.jcId = params.jcId;
                _this.manhours.baytransJcId = _this.jcId + "";
            }
        });
        this.route.queryParams.filter(function (params) { return params.branchName; }).subscribe(function (params) {
            if ((params.branchName != undefined) && (params.branchName != '')) {
                _this.branchName = params.branchName;
            }
        });
        console.log(this.branchName);
        console.log(this.manhours.baytransJcId);
    }
    ManHoursComponent.prototype.ngOnInit = function () {
        this.populateDropDownData();
        this.manHoursForm = new __WEBPACK_IMPORTED_MODULE_6__angular_forms__["FormGroup"]({
            'bayBranchId': new __WEBPACK_IMPORTED_MODULE_6__angular_forms__["FormControl"]('', [__WEBPACK_IMPORTED_MODULE_6__angular_forms__["Validators"].required]),
            'baytransBayId': new __WEBPACK_IMPORTED_MODULE_6__angular_forms__["FormControl"]('', [__WEBPACK_IMPORTED_MODULE_6__angular_forms__["Validators"].required]),
            'baytransJcId': new __WEBPACK_IMPORTED_MODULE_6__angular_forms__["FormControl"]('', [__WEBPACK_IMPORTED_MODULE_6__angular_forms__["Validators"].required, __WEBPACK_IMPORTED_MODULE_6__angular_forms__["Validators"].pattern(NUM_REGAX)]),
            'baytransEmpId': new __WEBPACK_IMPORTED_MODULE_6__angular_forms__["FormControl"]('', [__WEBPACK_IMPORTED_MODULE_6__angular_forms__["Validators"].required]),
        });
    };
    Object.defineProperty(ManHoursComponent.prototype, "bayBranchId", {
        get: function () { return this.manHoursForm.get('bayBranchId'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ManHoursComponent.prototype, "baytransJcId", {
        get: function () { return this.manHoursForm.get('baytransJcId'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ManHoursComponent.prototype, "baytransBayId", {
        get: function () { return this.manHoursForm.get('baytransBayId'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ManHoursComponent.prototype, "baytransEmpId", {
        get: function () { return this.manHoursForm.get('baytransEmpId'); },
        enumerable: true,
        configurable: true
    });
    ;
    ManHoursComponent.prototype.toggleAnimation = function () {
    };
    ManHoursComponent.prototype.populateDropDownData = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
        this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/customer-populate/bay', {}, { headers: headers, withCredentials: true }).subscribe(function (data) {
            _this.bay = data['populateJcBays'];
        });
    ...
    ManHoursComponent.prototype.populateData = function () {
    };
    ManHoursComponent.prototype.ngAfterViewInit = function () {
    };
    ManHoursComponent.prototype.onSubmit = function () {
        var _this = this;
        if (this.manhours.baytransJcId != '0') {
            this.manhours.bayBranchId == '1';
        }
        if (!this.manHoursForm.invalid) {
            if (this.manhours.baytransId == '0') {
                this.manhours['requestType'] = 'START';
            }
            else {
                this.manhours['requestType'] = 'STOP';
            }
            var headers = new __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
            this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/service/manhours', JSON.stringify(this.manhours), { headers: headers, withCredentials: true }).subscribe(function (data) {
                _this.manhours.baytransId = data['baytransId'];
        ...
        console.log(this.manhours);
    };
    return ManHoursComponent;
}());
__decorate([
...
], ManHoursComponent.prototype, "sort", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('@flyInOutTrigger'),
    __metadata("design:type", Object)
], ManHoursComponent.prototype, "flyInOutTrigger", void 0);
__decorate([
...
], ManHoursComponent.prototype, "toast", void 0);
ManHoursComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: ".m-grid__item.m-grid__item--fluid.m-wrapper",
        template: __webpack_require__("../../../../../src/app/theme/pages/service/man-hours/man-hours.component.html"),
    ...
    __metadata("design:paramtypes", [typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__services_script_loader_service__["a" /* ScriptLoaderService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_script_loader_service__["a" /* ScriptLoaderService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_15__angular_router__["Router"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_15__angular_router__["Router"]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["b" /* HttpClient */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_15__angular_router__["ActivatedRoute"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_15__angular_router__["ActivatedRoute"]) === "function" && _f || Object])
], ManHoursComponent);

var ManHoursData = (function () {
    function ManHoursData() {
        this.baytransId = '0';
    }
    return ManHoursData;
}());
...
//# sourceMappingURL=man-hours.component.js.map

/***/ }),

/***/ "../../../../../src/app/theme/pages/service/man-hours/man-hours.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManHoursModule", function() { return ManHoursModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__man_hours_component__ = __webpack_require__("../../../../../src/app/theme/pages/service/man-hours/man-hours.component.ts");
...
var routes = [
    {
        ...
        "children": [
            {
                "path": "",
                "component": __WEBPACK_IMPORTED_MODULE_3__man_hours_component__["a" /* ManHoursComponent */]
            }
        ]
    }
];
var ManHoursModule = (function () {
    function ManHoursModule() {
    }
    return ManHoursModule;
}());
ManHoursModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        ], declarations: [__WEBPACK_IMPORTED_MODULE_3__man_hours_component__["a" /* ManHoursComponent */],],
    })
], ManHoursModule);

//# sourceMappingURL=man-hours.module.js.map

/***/ })

});
//# sourceMappingURL=man-hours.module.chunk.js.map