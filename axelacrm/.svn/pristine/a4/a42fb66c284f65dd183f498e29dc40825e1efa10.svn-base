webpackJsonp(["item-batch-list.module"],{

/***/ "../../../../../src/app/theme/pages/inventory/item-batch/item-batch-add.component.html":
/***/ (function(module, exports) {

module.exports = "<toast></toast>\r\n\t\t\r\n\t\t<div class=\"m-subheader\">\t\t\t\r\n\t\t\t<div class=\"mr-auto\">\r\n\t\t\t<h3 class=\"m-subheader__title m-subheader__title--separator\">\r\n\t\t\t\t{{status}} Batch\r\n\r\n\t\t\t</h3>\r\n\t\t\t<ul class=\"m-subheader__breadcrumbs m-nav m-nav--inline\">\r\n\t\t\t\t\r\n\t\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t\t<a href=\"\" class=\"m-nav__link\">\r\n\t\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\t\tHome\r\n\t\t\t\t\t\t</span>\r\n\t\t\t\t\t</a>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__separator\">\r\n\t\t\t\t\t>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t\t<a routerLink=\"/portal/manager\" class=\"m-nav__link\">\r\n\t\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\t\tBusiness Manager\r\n\t\t\t\t\t\t</span>\r\n\t\t\t\t\t</a>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__separator\">\r\n\t\t\t\t\t>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t\t<a href=\"\" class=\"m-nav__link\">\r\n\t\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\t\tList Batch:\r\n\r\n\t\t\t\t\t\t</span>\r\n\t\t\t\t\t</a>\r\n\t\t\t\t</li>\r\n\t\t\t</ul>\r\n\t\t</div>\r\n\t\t</div>\r\n\t\r\n\t<mat-card>\r\n\t\t\t\t\r\n\t<form (ngSubmit)=\"onSubmit()\" class=\"m-form m-form--fit m-form--label-align-right\" [formGroup]=\"itemBatchForm\" id=\"m_form_1\">\r\n\t\t\t \r\n\t\t<div class=\"m-portlet__body row\">\r\n\t\t<div class='col-md-6'>\r\n\t\t\t<mat-form-field >\r\n\t\t\t\t<input matInput placeholder=\"Batch No.\" [(ngModel)]=\"itembatch.batchNo\" formControlName=\"batchNo\" required>\r\n\t\t\t\t<mat-error *ngIf=\"batchNo.hasError('required')\">\r\n      \t\t\t\t\tBatch Enter Number\r\n   \t\t\t\t </mat-error>\r\n\t\t\t</mat-form-field>\r\n\t\t</div>\r\n\r\n\t\t\r\n\r\n\t\t<div class='col-md-6 '>\r\n\t\t\t<mat-form-field >\r\n\t\t\t\t<input matInput placeholder=\"Batch Time\" [(ngModel)]=\"itembatch.batchTime\" formControlName=\"batchTime\" required>\r\n\t\t\t\t<mat-error *ngIf=\"batchTime.hasError('required')\">\r\n      \t\t\t\t\tEnter Short Name\r\n   \t\t\t\t </mat-error>\r\n\t\t\t</mat-form-field>\r\n\t\t</div>\r\n\t\t\t\r\n\t\r\n\t\t<div class='col-md-6'>\r\n\t\t\t<mat-form-field >\r\n\t\t\t\t\t<input matInput placeholder=\"Expiry Date\" [(ngModel)]=\"itembatch.batchExpiryDate\" formControlName=\"batchExpiryDate\" required>\r\n\t\t\t\t\t<mat-error *ngIf=\"batchExpiryDate.hasError('required')\">\r\n\t\t\t\t\t\t\tEnter Expiry Date\r\n\t\t\t\t\t </mat-error>\r\n\t\t\t\t</mat-form-field>\r\n\t\t</div>\r\n\t\t\r\n\t\t<div class='col-md-6'> Active\r\n            <mat-checkbox  [(ngModel)]=\"itembatch.batchActive\" formControlName=\"batchActive\" ></mat-checkbox>\r\n         </div>\r\n\t\t\t\r\n\t\t<div class='col-md-6'>\r\n\t\t\t<mat-form-field>\r\n\t\t\t\t<textarea matInput placeholder=\"Description\" matAutosizeMinRows=\"2\" [(ngModel)]=\"itembatch.batchDesc\" \t\t\tformControlName=\"batchDesc\" maxlength=\"255\" >\t\t\t\t\t\t\t\t\t\t\t\r\n\t\t\t\t</textarea>\r\n\t\t\t\t<mat-hint>(5000 Characters)</mat-hint>\r\n\t\t\t</mat-form-field>\r\n\t\t</div>\r\n\t\t\t\r\n\t\t<div class='col-md-12 row' *ngIf=\"this.itembatch.batchEntryId \" style=\"margin-top: 2em;\">\r\n\t\t\t<div class='col-md-6'>\r\n\t\t\t\t\t\t<label>Entry By:</label> \r\n\t\t\t\t<a href=\"\">{{itembatch.batchEntryId}}</a>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t\r\n\t\t\t\t\t<div class='col-md-6'>\r\n\t\t\t\t\t\t<label>Entry Date:</label> {{itembatch.batchEntryDate}}\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t\t\r\n\t\t\t\t<div class='col-md-12 row' *ngIf=\"this.itembatch.batchModifiedId \" style=\"margin-top: 2em;\">\r\n\t\t\t\t\t<div class='col-md-6'>\r\n\t\t\t\t\t\t<label>Modified By:</label> \r\n\t\t\t\t\t\t<a href=\"\">{{itembatch.batchModifiedId}}</a>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t\r\n\t\t\t\t\t<div class='col-md-6'>\r\n\t\t\t\t\t\t<label>Modified Date:</label> {{itembatch.batchModifiedDate}}\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t\t\r\n\t\t\t\t\r\n\t\t\t\t <div class=\"col-md-12  btn-row\" *ngIf=\"this.batchId=='0'\">\r\n\t\t\t\t\t <button mat-button [disabled]=\"false\" class=\"btn btn-primary\"> Add </button> \r\n\t\t\t\t\t <button mat-button class=\"btn btn-primary\" (click)=\"toggleAnimation()\" type=\"button\"> Cancel </button>\r\n\t\t\t\t</div>\r\n\t\t\t \r\n\t\t\t\t<div class=\"col-md-12  btn-row\" *ngIf=\"this.batchId!='0'\"> \r\n\t\t\t\t <button mat-button [disabled]=\"false\" class=\"btn btn-primary\"> Update </button> \r\n\t\t\t\t\t <button mat-button [disabled]=\"false\" (click)=\"onDelete()\" class=\"btn btn-primary\" type=\"button\"> Delete </button> \r\n\t\t\t\t\t <button  mat-button class=\"btn btn-primary\" (click)=\"toggleAnimation()\" type=\"button\"> Cancel </button>\r\n\t\t\t\t</div>\r\n\t\t</div>\r\n\t</form>\t\r\n\t\r\n\t</mat-card>\r\n"

/***/ }),

/***/ "../../../../../src/app/theme/pages/inventory/item-batch/item-batch-add.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ItemBatchAddComponent; });
/* unused harmony export ItemBatchData */
...
var PIN_REGEX = /^\d{6}$/;
var NUM_REGAX = /[0-9]/;
var ItemBatchAddComponent = (function () {
    function ItemBatchAddComponent(_script, http, _router, route) {
        var _this = this;
        ...
        this.batchId = 0;
        this.itembatch = new ItemBatchData();
        this.msg = [];
        this.bootstrapFromValues = [];
        this.route.queryParams.filter(function (params) { return params.batchId; }).subscribe(function (params) {
    ...
    ItemBatchAddComponent.prototype.ngOnInit = function () {
        this.itemBatchForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormGroup"]({
            'batchNo': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]('', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]),
            'batchTime': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]('', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]),
            'batchExpiryDate': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]('', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]),
            'batchDesc': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'batchActive': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'batchEntryId': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'batchEntryDate': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'batchModifiedId': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'batchModifiedDate': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
        });
    };
    Object.defineProperty(ItemBatchAddComponent.prototype, "batchNo", {
        get: function () { return this.itemBatchForm.get('batchNo'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ItemBatchAddComponent.prototype, "batchTime", {
        get: function () { return this.itemBatchForm.get('batchTime'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ItemBatchAddComponent.prototype, "batchExpiryDate", {
        get: function () { return this.itemBatchForm.get('batchExpiryDate'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ItemBatchAddComponent.prototype, "batchDesc", {
        get: function () { return this.itemBatchForm.get('batchDesc'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ItemBatchAddComponent.prototype, "batchActive", {
        get: function () { return this.itemBatchForm.get('batchActive'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ItemBatchAddComponent.prototype, "batchEntryId", {
        get: function () { return this.itemBatchForm.get('batchEntryId'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ItemBatchAddComponent.prototype, "batchEntryDate", {
        get: function () { return this.itemBatchForm.get('batchEntryDate'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ItemBatchAddComponent.prototype, "batchModifiedId", {
        get: function () { return this.itemBatchForm.get('batchModifiedId'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(ItemBatchAddComponent.prototype, "batchModifiedDate", {
        get: function () { return this.itemBatchForm.get('batchModifiedDate'); },
        enumerable: true,
        configurable: true
    });
    ;
    ItemBatchAddComponent.prototype.populateData = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
        this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/customer/customer-data ', JSON.stringify({ 'batchId': this.batchId }), { headers: headers, withCredentials: true }).subscribe(function (data) {
            _this.itembatch = data['populatadata'][0];
            console.log("batchModifiedId==" + _this.itembatch.batchModifiedId);
        }, function (err) {
            /* this function is executed when there's an ERROR */
            console.log("ERROR: " + err);
        });
    };
    ItemBatchAddComponent.prototype.ngAfterViewInit = function () { };
    ItemBatchAddComponent.prototype.toggleAnimation = function () {
        this._router.navigate(['portal/customer-group-list']); //path should be changed
    };
    ItemBatchAddComponent.prototype.onSubmit = function () {
        var _this = this;
        this.bootstrapFromValues = $('#m_form_1').serializeArray();
        for (var i = 0; i < this.bootstrapFromValues.length; i++) {
            this.itembatch[this.bootstrapFromValues[i].name] = this.bootstrapFromValues[i].value;
        }
        if (!this.itemBatchForm.invalid) {
            var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
            if (this.batchId == 0) {
                this.itembatch['requestType'] = 'add';
            }
            else {
                this.itembatch['requestType'] = 'update';
                this.itembatch['batchId'] = this.batchId + '';
            }
            this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/inventory/itembatch', JSON.stringify(this.itembatch), { headers: headers, withCredentials: true }).subscribe(function (data) {
        ...
        console.log(this.itembatch);
    };
    ItemBatchAddComponent.prototype.onDelete = function () {
        var _this = this;
        this.itembatch['requestType'] = 'delete';
        this.itembatch['batchId'] = this.batchId + '';
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
        this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/inventory/itembatch', JSON.stringify(this.itembatch), { headers: headers, withCredentials: true }).subscribe(function (data) {
            if (data['successmsg'].includes('Successfully')) {
    ...
    return ItemBatchAddComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('@flyInOutTrigger'),
    __metadata("design:type", Object)
], ItemBatchAddComponent.prototype, "flyInOutTrigger", void 0);
ItemBatchAddComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: ".m-grid__item.m-grid__item--fluid.m-wrapper",
        template: __webpack_require__("../../../../../src/app/theme/pages/inventory/item-batch/item-batch-add.component.html"),
...
var ItemBatchListComponent = (function () {
    function ItemBatchListComponent(_script, http, _router) {
        this._script = _script;
        this.http = http;
        this._router = _router;
        this.flyInOutTrigger = 'in';
    ...
    ItemBatchListComponent.prototype.ngAfterViewInit = function () {
    };
    ItemBatchListComponent.prototype.ngOnInit = function () {
        this.smart.smartUrl = sessionStorage.getItem('requestUrl') + "/axelacrm/inventory/itembatch-smartsearch";
        this.list.listUrl = sessionStorage.getItem('requestUrl') + "/axelacrm/inventory/group-list"; //path should be changed
    };
    ItemBatchListComponent.prototype.toggleAnimation = function () {
        this._router.navigate(['inventory/item-batch-list/ItemBatchadd'], { queryParams: { batchId: this.batchId } });
    };
    ItemBatchListComponent.prototype.smartClickListener = function (event) {
        this.list.listParam['requestType'] = 'filter';
        this.list.listParam['smartParam'] = event;
        this.list.getData();
    };
    ItemBatchListComponent.prototype.smartToggle = function () {
        if (this.smartHide) {
    ...
    ItemBatchListComponent.prototype.listClickListener = function (listParam) {
        if (listParam[0] == 'updateItemBatch') {
            this.batchId = listParam[1];
            this.toggleAnimation();
            //			this.itemBatchForm.reset();
        }
    };
    return ItemBatchListComponent;
}());
__decorate([
...
], ItemBatchListComponent.prototype, "smart", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('@flyInOutTrigger'),
    __metadata("design:type", Object)
], ItemBatchListComponent.prototype, "flyInOutTrigger", void 0);
__decorate([
...
], ItemBatchListComponent.prototype, "list", void 0);
__decorate([
...
], ItemBatchListComponent.prototype, "toast", void 0);
ItemBatchListComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: ".m-grid__item.m-grid__item--fluid.m-wrapper",
        template: __webpack_require__("../../../../../src/app/theme/pages/inventory/item-batch/item-batch-list.component.html"),
        encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewEncapsulation"].None,
...
], ItemBatchListComponent);

var _a, _b, _c, _d, _e, _f;
//# sourceMappingURL=item-batch-list.component.js.map

/***/ }),

/***/ "../../../../../src/app/theme/pages/inventory/item-batch/item-batch-list.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ItemBatchListModule", function() { return ItemBatchListModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__item_batch_list_component__ = __webpack_require__("../../../../../src/app/theme/pages/inventory/item-batch/item-batch-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__item_batch_add_component__ = __webpack_require__("../../../../../src/app/theme/pages/inventory/item-batch/item-batch-add.component.ts");
...
var routes = [
    {
        ...
        "children": [
            {
                "path": "",
                "component": __WEBPACK_IMPORTED_MODULE_0__item_batch_list_component__["a" /* ItemBatchListComponent */]
            }
        ]
    }, {
        "path": "ItemBatchadd",
        ...
        "children": [
            {
                "path": "",
                "component": __WEBPACK_IMPORTED_MODULE_1__item_batch_add_component__["a" /* ItemBatchAddComponent */],
            }
        ]
    }
];
var ItemBatchListModule = (function () {
    function ItemBatchListModule() {
    }
    return ItemBatchListModule;
}());
ItemBatchListModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_0__item_batch_list_component__["a" /* ItemBatchListComponent */], __WEBPACK_IMPORTED_MODULE_1__item_batch_add_component__["a" /* ItemBatchAddComponent */]
            //		,SmartSearchComponent
        ],
    })
], ItemBatchListModule);

//# sourceMappingURL=item-batch-list.module.js.map

/***/ })

});
//# sourceMappingURL=item-batch-list.module.chunk.js.map