...
var DepartmentListComponent = (function () {
    function DepartmentListComponent(router, http) {
        this.router = router;
        this.http = http;
    ...
    DepartmentListComponent.prototype.ngOnInit = function () {
        //		this.smart.smartUrl = sessionStorage.getItem('requestUrl')+"/axelacrm/portal/department-smartsearch";
        //  		this.list.listUrl=sessionStorage.getItem('requestUrl')+"/axelacrm/portal/department-list";
    };
    DepartmentListComponent.prototype.ngAfterViewInit = function () {
    };
    DepartmentListComponent.prototype.smartToggle = function () {
        if (this.smartHide) {
    ...
    DepartmentListComponent.prototype.toggleAnimation = function () {
        this.router.navigate(['portal/department-list/department-add'], { queryParams: { departmentId: this.departmentId } });
    };
    DepartmentListComponent.prototype.listClickListener = function (listParam) {
        if (listParam[0] == 'updatedepartment') {
            this.departmentId = listParam[1];
            this.toggleAnimation();
        }
    };
    DepartmentListComponent.prototype.smartClickListener = function (event) {
...
], DepartmentListComponent.prototype, "flyInOutTrigger", void 0);
__decorate([
...
], DepartmentListComponent.prototype, "list", void 0);
__decorate([
...
], DepartmentListComponent.prototype, "toast", void 0);
DepartmentListComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: ".m-grid__item.m-grid__item--fluid.m-wrapper",
        template: __webpack_require__("../../../../../src/app/theme/pages/portal/department/department-list.component.html"),
...
/***/ "../../../../../src/app/theme/pages/portal/department/department-list.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__department_list_component__ = __webpack_require__("../../../../../src/app/theme/pages/portal/department/department-list.component.ts");
...
var routes = [
    {
        ...
        "children": [
            {
                "path": "",
                "component": __WEBPACK_IMPORTED_MODULE_3__department_list_component__["a" /* DepartmentListComponent */]
            }
        ]
    } /*,{
        "path": "department-add",
...
var DepartmentListModule = (function () {
    function DepartmentListModule() {
    }
    return DepartmentListModule;
}());
DepartmentListModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        declarations: [__WEBPACK_IMPORTED_MODULE_3__department_list_component__["a" /* DepartmentListComponent */]],
    })
], DepartmentListModule);

//# sourceMappingURL=department-list.module.js.map

/***/ })

});
//# sourceMappingURL=department-list.module.chunk.js.map