webpackJsonp(["jc-type-list.module"],{

/***/ "../../../../../src/app/theme/pages/service/job-card/jc-type/jc-type-add.component.html":
/***/ (function(module, exports) {

module.exports = "<toast></toast>\r\n\r\n\t\t\r\n\t\t<div class=\"m-subheader\">\t\t\t\r\n\t\t\t<div class=\"mr-auto\">\r\n\t\t\t<h3 class=\"m-subheader__title m-subheader__title--separator\">\r\n\t\t\t\t{{status}} Job Card Type\r\n\t\t\t</h3>\r\n\t\t\t<ul class=\"m-subheader__breadcrumbs m-nav m-nav--inline\">\r\n\t\t\t\t\r\n\t\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t\t<a href=\"\" class=\"m-nav__link\">\r\n\t\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\t\tHome\r\n\t\t\t\t\t\t</span>\r\n\t\t\t\t\t</a>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__separator\">\r\n\t\t\t\t\t>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t\t<a href=\"/portal/manager\" class=\"m-nav__link\">\r\n\t\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\t\tBusiness Manager\r\n\t\t\t\t\t\t</span>\r\n\t\t\t\t\t</a>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__separator\">\r\n\t\t\t\t\t>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t\t<a href=\"service/jc-type-list\" class=\"m-nav__link\">\r\n\t\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\t\tList Job Card Type:\r\n\t\t\t\t\t\t</span>\r\n\t\t\t\t\t</a>\r\n\t\t\t\t</li>\r\n\t\t\t</ul>\r\n\t\t</div>\r\n\t\t</div>\r\n\t\r\n\t<mat-card>\r\n\t\t\t\t\r\n\t<form (ngSubmit)=\"onSubmit()\" class=\"m-form m-form--fit m-form--label-align-right\" [formGroup]=\"jcTypeForm\" id=\"m_form_1\">\r\n\t\t\t \r\n\t\t<div class=\"m-portlet__body row\">\r\n\t\t\r\n\t\t<div class='col-md-2'></div>\r\n\t\t<div class='col-md-8'>\r\n\t\t\t<mat-form-field >\r\n\t\t\t\t<input matInput placeholder=\"Name\" [(ngModel)]=\"jcType.jctypeName\" formControlName=\"jctypeName\" required>\r\n\t\t\t\t<mat-error *ngIf=\"jctypeName.hasError('required')\">\r\n      \t\t\t\t\tEnter Job Card Type Name\r\n   \t\t\t\t </mat-error>\r\n\t\t\t</mat-form-field>\r\n\t\t</div>\r\n\t\t<div class='col-md-2'></div>\r\n\t\t\r\n\t\t<div class='col-md-12 row' *ngIf=\"this.jcType.jctypeEntryId \" style=\"margin-top: 2em;\">\r\n\t\t\t<div class='col-md-6'>\r\n\t\t\t\t<label>Entry By:</label> <a href=\"\">{{jcType.jctypeEntryBy}}</a>\r\n\t\t\t</div>\r\n\t\t\t\r\n\t\t\t<div class='col-md-6'>\r\n\t\t\t\t<label>Entry Date:</label> {{jcType.jctypeEntryDate}}\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t\r\n\t\t<div class='col-md-12 row' *ngIf=\"this.jcType.jctypeModifiedId \" style=\"margin-top: 2em;\">\r\n\t\t\t<div class='col-md-6'>\r\n\t\t\t\t<label>Modified By:</label> <a href=\"\">{{jcType.jctypeModifiedBy}}</a>\r\n\t\t\t</div>\r\n\t\t\t\r\n\t\t\t<div class='col-md-6'>\r\n\t\t\t\t<label>Modified Date:</label> {{jcType.jctypeModifiedDate}}\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t\t\r\n\t\t\r\n\t\t <div class=\"col-md-12  btn-row\" *ngIf=\"this.jctypeId=='0'\">\r\n\t\t\t <button mat-button [disabled]=\"false\" class=\"btn btn-primary\"> Add </button> \r\n\t\t\t <button mat-button class=\"btn btn-primary\" (click)=\"toggleAnimation()\" type=\"button\"> Cancel </button>\r\n\t\t</div>\r\n\t\t\r\n\t\t<div class=\"col-md-12  btn-row\" *ngIf=\"this.jctypeId!='0'\">\r\n\t\t <button mat-button [disabled]=\"false\" class=\"btn btn-primary\"> Update </button>  \r\n\t\t\t <button mat-button [disabled]=\"false\" (click)=\"onDelete()\" class=\"btn btn-primary\" type=\"button\"> Delete </button> \r\n\t\t\t <button  mat-button class=\"btn btn-primary\" (click)=\"toggleAnimation()\" type=\"button\"> Cancel </button>\r\n\t\t</div>\r\n\t\t</div>\r\n\t</form>\t\r\n\t</mat-card>"

/***/ }),

/***/ "../../../../../src/app/theme/pages/service/job-card/jc-type/jc-type-add.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return JcTypeAddComponent; });
/* unused harmony export TypeData */
...
var PIN_REGEX = /^\d{6}$/;
var NUM_REGAX = /[0-9]/;
var JcTypeAddComponent = (function () {
    function JcTypeAddComponent(_script, http, _router, route) {
        var _this = this;
        ...
        this.jctypeId = 0;
        this.jcType = new TypeData();
        this.msg = [];
        this.bootstrapFromValues = [];
        this.route.queryParams.filter(function (params) { return params.jctypeId; }).subscribe(function (params) {
            if (params.jctypeId != undefined) {
                _this.jctypeId = params.jctypeId;
            }
        });
        //	console.log("jctypeId=="+this.jctypeId);
        if (this.jctypeId == 0) {
            this.status = "Add";
        }
        else {
    ...
    JcTypeAddComponent.prototype.ngOnInit = function () {
        this.jcTypeForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormGroup"]({
            'jctypeId': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'jctypeName': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]('', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]),
            'jctypeEntryId': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'jctypeEntryDate': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'jctypeModifiedId': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'jctypeModifiedDate': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
        });
    };
    Object.defineProperty(JcTypeAddComponent.prototype, "jctypeName", {
        get: function () { return this.jcTypeForm.get('jctypeName'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(JcTypeAddComponent.prototype, "jctypeEntryId", {
        get: function () { return this.jcTypeForm.get('jctypeEntryId'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(JcTypeAddComponent.prototype, "jctypeEntryDate", {
        get: function () { return this.jcTypeForm.get('jctypeEntryDate'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(JcTypeAddComponent.prototype, "jctypeModifiedId", {
        get: function () { return this.jcTypeForm.get('jctypeModifiedId'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(JcTypeAddComponent.prototype, "jctypeModifiedDate", {
        get: function () { return this.jcTypeForm.get('jctypeModifiedDate'); },
        enumerable: true,
        configurable: true
    });
    ;
    JcTypeAddComponent.prototype.populateData = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
        this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/portal/jctype-data ', JSON.stringify({ 'jctypeId': this.jctypeId }), { headers: headers, withCredentials: true }).subscribe(function (data) {
            _this.jcType = data['populateData'][0];
            console.log("jctypeModifiedId==" + _this.jcType.jctypeModifiedId);
        }, function (err) {
            /* this function is executed when there's an ERROR */
            console.log("ERROR: " + err);
        });
    };
    JcTypeAddComponent.prototype.ngAfterViewInit = function () { };
    JcTypeAddComponent.prototype.toggleAnimation = function () {
        this._router.navigate(['service/jc-type-list']);
    };
    JcTypeAddComponent.prototype.onSubmit = function () {
        var _this = this;
        this.bootstrapFromValues = $('#m_form_1').serializeArray();
        for (var i = 0; i < this.bootstrapFromValues.length; i++) {
            this.jcType[this.bootstrapFromValues[i].name] = this.bootstrapFromValues[i].value;
        }
        if (!this.jcTypeForm.invalid) {
            var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
            if (this.jctypeId == 0) {
                this.jcType['requestType'] = 'add';
            }
            else {
                this.jcType['requestType'] = 'update';
                this.jcType['jctypeId'] = this.jctypeId + '';
            }
            this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/portal/jctype', JSON.stringify(this.jcType), { headers: headers, withCredentials: true }).subscribe(function (data) {
    ...
    JcTypeAddComponent.prototype.onDelete = function () {
        var _this = this;
        this.jcType['requestType'] = 'delete';
        this.jcType['jctypeId'] = this.jctypeId + '';
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
        this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/portal/jctype', JSON.stringify(this.jcType), { headers: headers, withCredentials: true }).subscribe(function (data) {
            if (data['successmsg'].includes('Successfully')) {
    ...
    return JcTypeAddComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('@flyInOutTrigger'),
    __metadata("design:type", Object)
], JcTypeAddComponent.prototype, "flyInOutTrigger", void 0);
__decorate([
...
], JcTypeAddComponent.prototype, "toast", void 0);
JcTypeAddComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: ".m-grid__item.m-grid__item--fluid.m-wrapper",
        template: __webpack_require__("../../../../../src/app/theme/pages/service/job-card/jc-type/jc-type-add.component.html"),
...
var JcTypeListComponent = (function () {
    function JcTypeListComponent(_script, http, _router) {
        this._script = _script;
        this.http = http;
        this._router = _router;
        this.flyInOutTrigger = 'in';
    ...
    JcTypeListComponent.prototype.ngAfterViewInit = function () {
    };
    JcTypeListComponent.prototype.ngOnInit = function () {
        this.smart.smartUrl = sessionStorage.getItem('requestUrl') + "/axelacrm/service/jctype-smartsearch";
        this.list.listUrl = sessionStorage.getItem('requestUrl') + "/axelacrm/service/jctype-list";
    };
    JcTypeListComponent.prototype.toggleAnimation = function () {
        this._router.navigate(['service/jc-type-list/JCTypeadd'], { queryParams: { jctypeId: this.jctypeId } });
    };
    JcTypeListComponent.prototype.smartClickListener = function (event) {
        this.list.listParam['requestType'] = 'filter';
        this.list.listParam['smartParam'] = event;
        this.list.getData();
    };
    JcTypeListComponent.prototype.smartToggle = function () {
        if (this.smartHide) {
    ...
    JcTypeListComponent.prototype.listClickListener = function (listParam) {
        if (listParam[0] == 'updateJCType') {
            this.jctypeId = listParam[1];
            this.toggleAnimation();
            //			this.jcTypeForm.reset();
        }
    };
    return JcTypeListComponent;
}());
__decorate([
...
], JcTypeListComponent.prototype, "smart", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('@flyInOutTrigger'),
    __metadata("design:type", Object)
], JcTypeListComponent.prototype, "flyInOutTrigger", void 0);
__decorate([
...
], JcTypeListComponent.prototype, "list", void 0);
__decorate([
...
], JcTypeListComponent.prototype, "toast", void 0);
JcTypeListComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: ".m-grid__item.m-grid__item--fluid.m-wrapper",
        template: __webpack_require__("../../../../../src/app/theme/pages/service/job-card/jc-type/jc-type-list.component.html"),
        encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewEncapsulation"].None,
        animations: [
...
//# sourceMappingURL=jc-type-list.component.js.map

/***/ }),

/***/ "../../../../../src/app/theme/pages/service/job-card/jc-type/jc-type-list.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JcTypeListModule", function() { return JcTypeListModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__jc_type_list_component__ = __webpack_require__("../../../../../src/app/theme/pages/service/job-card/jc-type/jc-type-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__jc_type_add_component__ = __webpack_require__("../../../../../src/app/theme/pages/service/job-card/jc-type/jc-type-add.component.ts");
...
var routes = [
    {
        ...
        "children": [
            {
                "path": "",
                "component": __WEBPACK_IMPORTED_MODULE_3__jc_type_list_component__["a" /* JcTypeListComponent */]
            }
        ]
    }, {
        "path": "JCTypeadd",
        ...
        "children": [
            {
                "path": "",
                "component": __WEBPACK_IMPORTED_MODULE_4__jc_type_add_component__["a" /* JcTypeAddComponent */],
            }
        ]
    }
];
var JcTypeListModule = (function () {
    function JcTypeListModule() {
    }
    return JcTypeListModule;
}());
JcTypeListModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__jc_type_list_component__["a" /* JcTypeListComponent */], __WEBPACK_IMPORTED_MODULE_4__jc_type_add_component__["a" /* JcTypeAddComponent */]
        ],
    })
], JcTypeListModule);

//# sourceMappingURL=jc-type-list.module.js.map

/***/ })

});
//# sourceMappingURL=jc-type-list.module.chunk.js.map