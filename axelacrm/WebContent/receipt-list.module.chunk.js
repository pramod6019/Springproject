...
var ReceiptListComponent = (function () {
    function ReceiptListComponent(_script, http) {
        ...
        this.pageIndex = 1;
        this.receipt = new ReceiptData();
        this.branchs = [];
    }
    ReceiptListComponent.prototype.ngOnInit = function () {
        this.receiptForm = new __WEBPACK_IMPORTED_MODULE_7__angular_forms__["FormGroup"]({});
        this.listHide = false;
        this.animateAdd = 'out';
        this.animateList = 'in';
        this.list.listUrl = "http://localhost:8060/axelacrm/service/#";
    };
    ReceiptListComponent.prototype.toggleAnimation = function () {
    ...
    ReceiptListComponent.prototype.populateDropDownData = function () {
        this.opened = true;
    };
    ReceiptListComponent.prototype.populateData = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
        this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/slaes/receipt-data', JSON.stringify({ receiptId: this.receiptId }), { headers: headers, withCredentials: true }).subscribe(function (data) {
            _this.receipt = data['populateData'][0];
        }, function (err) {
    ...
    ReceiptListComponent.prototype.ngAfterViewInit = function () {
        if (!this.addHide) {
            this.addHide = true;
        }
        else {
    ...
    ReceiptListComponent.prototype.onSubmit = function () {
        var _this = this;
        alert("submit");
        if (!this.receiptForm.invalid) {
            var headers = new __WEBPACK_IMPORTED_MODULE_4__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
            if (this.receiptId == 0) {
                this.receipt['requestType'] = 'add';
            }
            else {
                this.receipt['requestType'] = 'update';
                this.receipt['receiptId'] = this.receiptId + '';
            }
            this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/service/receipt;', JSON.stringify(this.receipt), { headers: headers, withCredentials: true }).subscribe(function (data) {
                _this.toggleAnimation();
                _this.receiptForm.reset();
                _this.list.getData();
            });
        }
    };
    ReceiptListComponent.prototype.listClickListener = function (listParam) {
        if (listParam[0] == 'updaterReceipt') {
            this.receiptId = listParam[1];
...
], ReceiptListComponent.prototype, "sort", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('@flyInOutTrigger'),
    __metadata("design:type", Object)
], ReceiptListComponent.prototype, "flyInOutTrigger", void 0);
__decorate([
...
], ReceiptListComponent.prototype, "list", void 0);
ReceiptListComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: ".m-grid__item.m-grid__item--fluid.m-wrapper",
        template: __webpack_require__("../../../../../src/app/theme/pages/service/receipt/receipt-list.component.html"),
...
/***/ "../../../../../src/app/theme/pages/service/receipt/receipt-list.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReceiptListModule", function() { return ReceiptListModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("../../../common/@angular/common.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("../../../router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__receipt_list_component__ = __webpack_require__("../../../../../src/app/theme/pages/service/receipt/receipt-list.component.ts");
...
var routes = [
    {
        ...
        "children": [
            {
                "path": "",
                "component": __WEBPACK_IMPORTED_MODULE_3__receipt_list_component__["a" /* ReceiptListComponent */]
            }
        ]
    }
];
var ReceiptListModule = (function () {
    function ReceiptListModule() {
    }
    return ReceiptListModule;
}());
ReceiptListModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__receipt_list_component__["a" /* ReceiptListComponent */],
        ],
    })
], ReceiptListModule);

//# sourceMappingURL=receipt-list.module.js.map

/***/ })

});
//# sourceMappingURL=receipt-list.module.chunk.js.map