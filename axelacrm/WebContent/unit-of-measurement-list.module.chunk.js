webpackJsonp(["unit-of-measurement-list.module"],{

/***/ "../../../../../src/app/theme/pages/inventory/unit-of-measurement/unit-of-measurement-add.component.html":
/***/ (function(module, exports) {

module.exports = " <toast></toast>\r\n\t\t\r\n\t\t<div class=\"m-subheader\">\t\t\t\r\n\t\t\t<div class=\"mr-auto\">\r\n\t\t\t<h3 class=\"m-subheader__title m-subheader__title--separator\">\r\n\t\t\t\t{{status}} UOM\r\n\t\t\t</h3>\r\n\t\t\t<ul class=\"m-subheader__breadcrumbs m-nav m-nav--inline\">\r\n\t\t\t\t\r\n\t\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t\t<a href=\"\" class=\"m-nav__link\">\r\n\t\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\t\tHome\r\n\t\t\t\t\t\t</span>\r\n\t\t\t\t\t</a>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__separator\">\r\n\t\t\t\t\t>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t\t<a routerLink=\"/portal/manager\" class=\"m-nav__link\">\r\n\t\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\t\tBusiness Manager\r\n\t\t\t\t\t\t</span>\r\n\t\t\t\t\t</a>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__separator\">\r\n\t\t\t\t\t>\r\n\t\t\t\t</li>\r\n\t\t\t\t<li class=\"m-nav__item\">\r\n\t\t\t\t\t<a href=\"\" class=\"m-nav__link\">\r\n\t\t\t\t\t\t<span class=\"m-nav__link-text\">\r\n\t\t\t\t\t\t\tList UOM:\r\n\t\t\t\t\t\t</span>\r\n\t\t\t\t\t</a>\r\n\t\t\t\t</li>\r\n\t\t\t</ul>\r\n\t\t</div>\r\n\t\t</div>\r\n\t\r\n\t<mat-card>\r\n\t\t\t\t\r\n\t<form (ngSubmit)=\"onSubmit()\" class=\"m-form m-form--fit m-form--label-align-right\" [formGroup]=\"unitOfMeasurementForm\" id=\"m_form_1\">\r\n\t\t\t \r\n\t\t<div class=\"m-portlet__body row\">\r\n\t\r\n\t\t\r\n\t\t<div class='col-md-6'>\r\n\t\t\t<mat-form-field >\r\n\t\t\t\t<input matInput placeholder=\"Name\" [(ngModel)]=\"unitofmeasurement.uomName\" formControlName=\"uomName\" required>\r\n\t\t\t\t<mat-error *ngIf=\"uomName.hasError('required')\">\r\n      \t\t\t\t\tEnter Name\r\n   \t\t\t\t </mat-error>\r\n\t\t\t</mat-form-field>\r\n\t\t</div>\r\n\r\n\t\t\r\n\t\t<div class='col-md-6 '>\r\n\t\t\t<mat-form-field >\r\n\t\t\t\t<input matInput placeholder=\"Short Name\" [(ngModel)]=\"unitofmeasurement.uomShortname\" formControlName=\"uomShortname\" required>\r\n\t\t\t\t<mat-error *ngIf=\"uomShortname.hasError('required')\">\r\n      \t\t\t\t\tEnter Short Name\r\n   \t\t\t\t </mat-error>\r\n\t\t\t</mat-form-field>\r\n\t\t</div>\r\n\t\t\t\r\n\t\r\n\t\t<div class='col-md-6'>\r\n\t\t\t<mat-form-field>\r\n\t\t\t  <mat-select placeholder=\"Select Parent UOM\" [(ngModel)]=\"unitofmeasurement.uomParentId\" formControlName=\"uomParentId\">\r\n\t\t\t\t<mat-option *ngFor=\"let  uom of  uoms\" [value]=\" uom.key\">\r\n\t\t\t\t  {{  uom.name }}\r\n\t\t\t\t</mat-option>\r\n\t\t\t  </mat-select>\r\n\t\t\t </mat-form-field>\r\n\t\t</div>\r\n\t\t\t\r\n\t\t\t\t\r\n\t\t<div class='col-md-6 text-center'>\r\n\t\t\t<mat-form-field >\r\n\t\t\t\t<input matInput placeholder=\"Ratio\" [(ngModel)]=\"unitofmeasurement.uomRatio\" formControlName=\"uomRatio\" >\r\n\t\t\t</mat-form-field>\r\n\t\t</div>\r\n\r\n\t\t\t\r\n\t\t<div class='col-md-12 row' *ngIf=\"this.unitofmeasurement.uomEntryId \" style=\"margin-top: 2em;\">\r\n\t\t\t<div class='col-md-6'>\r\n\t\t\t\t<label>Entry By:</label> <a href=\"\">{{unitofmeasurement.uomEntryId}}</a>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t\r\n\t\t\t\t\t<div class='col-md-6'>\r\n\t\t\t\t\t\t<label>Entry Date:</label> {{unitofmeasurement.uomEntryDate}}\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t\t\r\n\t\t\t\t<div class='col-md-12 row' *ngIf=\"this.unitofmeasurement.uomModifiedId \" style=\"margin-top: 2em;\">\r\n\t\t\t\t\t<div class='col-md-6'>\r\n\t\t\t\t\t\t<label>Modified By:</label> <a href=\"\">{{unitofmeasurement.uomModifiedId}}</a>\r\n\t\t\t\t\t</div>\r\n\t\t\t\t\t\r\n\t\t\t\t\t<div class='col-md-6'>\r\n\t\t\t\t\t\t<label>Modified Date:</label> {{unitofmeasurement.uomModifiedDate}}\r\n\t\t\t\t\t</div>\r\n\t\t\t\t</div>\r\n\t\t\t\t\r\n\t\t\t\t\r\n\t\t\t\t <div class=\"col-md-12  btn-row\" *ngIf=\"this.uomId=='0'\">\r\n\t\t\t\t\t <button mat-button [disabled]=\"false\" class=\"btn btn-primary\"> Add </button> \r\n\t\t\t\t\t <button mat-button class=\"btn btn-primary\" (click)=\"toggleAnimation()\" type=\"button\"> Cancel </button>\r\n\t\t\t\t</div>\r\n\t\t\t \r\n\t\t\t\t<div class=\"col-md-12  btn-row\" *ngIf=\"this.uomId!='0'\">\r\n\t\t\t\t <button mat-button [disabled]=\"false\" class=\"btn btn-primary\"> Update </button>  \r\n\t\t\t\t\t <button mat-button [disabled]=\"false\" (click)=\"onDelete()\" class=\"btn btn-primary\" type=\"button\"> Delete </button> \r\n\t\t\t\t\t <button  mat-button class=\"btn btn-primary\" (click)=\"toggleAnimation()\" type=\"button\"> Cancel </button>\r\n\t\t\t\t</div>\r\n\t\t</div>\r\n\t</form>\t\r\n\t\r\n\t</mat-card>\r\n"

/***/ }),

/***/ "../../../../../src/app/theme/pages/inventory/unit-of-measurement/unit-of-measurement-add.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UnitOfMeasurementAddComponent; });
...
var PIN_REGEX = /^\d{6}$/;
var NUM_REGAX = /[0-9]/;
var UnitOfMeasurementAddComponent = (function () {
    function UnitOfMeasurementAddComponent(_script, http, _router, route) {
        var _this = this;
        ...
        this.route.queryParams.filter(function (params) { return params.uomId; }).subscribe(function (params) {
            if (params.uomId != undefined) {
                _this.uomId = params.uomId;
            }
        });
        console.log("uomId==" + this.uomId);
        if (this.uomId == 0) {
            this.status = "Add";
        }
        else {
    ...
    UnitOfMeasurementAddComponent.prototype.ngOnInit = function () {
        this.unitOfMeasurementForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormGroup"]({
            'uomName': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]('', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]),
            'uomShortname': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"]('', [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["Validators"].required]),
            'uomParentId': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'uomRatio': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'uomEntryId': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'uomEntryDate': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'uomModifiedId': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
            'uomModifiedDate': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["FormControl"](''),
        });
    };
    Object.defineProperty(UnitOfMeasurementAddComponent.prototype, "uomName", {
        get: function () { return this.unitOfMeasurementForm.get('uomName'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(UnitOfMeasurementAddComponent.prototype, "uomShortname", {
        get: function () { return this.unitOfMeasurementForm.get('uomShortname'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(UnitOfMeasurementAddComponent.prototype, "uomParentId", {
        get: function () { return this.unitOfMeasurementForm.get('uomParentId'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(UnitOfMeasurementAddComponent.prototype, "uomRatio", {
        get: function () { return this.unitOfMeasurementForm.get('uomRatio'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(UnitOfMeasurementAddComponent.prototype, "uomEntryId", {
        get: function () { return this.unitOfMeasurementForm.get('uomEntryId'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(UnitOfMeasurementAddComponent.prototype, "uomEntryDate", {
        get: function () { return this.unitOfMeasurementForm.get('uomEntryDate'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(UnitOfMeasurementAddComponent.prototype, "uomModifiedId", {
        get: function () { return this.unitOfMeasurementForm.get('uomModifiedId'); },
        enumerable: true,
        configurable: true
    });
    ;
    Object.defineProperty(UnitOfMeasurementAddComponent.prototype, "uomModifiedDate", {
        get: function () { return this.unitOfMeasurementForm.get('uomModifiedDate'); },
        enumerable: true,
        configurable: true
    });
    ;
    UnitOfMeasurementAddComponent.prototype.populateData = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
        this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/portal/uom-data ', JSON.stringify({ 'uomId': this.uomId }), { headers: headers, withCredentials: true }).subscribe(function (data) {
            _this.unitofmeasurement = data['populateData'][0];
    ...
    UnitOfMeasurementAddComponent.prototype.populateDropDownData = function () {
        var _this = this;
        var headers = new __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["d" /* HttpHeaders */]({ 'Content-Type': 'application/json' });
        this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/portal/uom-populate/branch', JSON.stringify({ emp_id: '0' }), { headers: headers, withCredentials: true }).subscribe(function (data) {
            _this.uoms = data['populateBranch'];
        });
    };
    UnitOfMeasurementAddComponent.prototype.ngAfterViewInit = function () { };
    UnitOfMeasurementAddComponent.prototype.toggleAnimation = function () {
        this._router.navigate(['inventory/unit-of-measurement-list']); //path should be changed
    };
    UnitOfMeasurementAddComponent.prototype.onSubmit = function () {
        var _this = this;
        this.bootstrapFromValues = $('#m_form_1').serializeArray();
        for (var i = 0; i < this.bootstrapFromValues.length; i++) {
            this.unitofmeasurement[this.bootstrapFromValues[i].name] = this.bootstrapFromValues[i].value;
        }
        if (!this.unitOfMeasurementForm.invalid) {
            ...
            this.http.post(sessionStorage.getItem('requestUrl') + '/axelacrm/portal/uom', JSON.stringify(this.unitofmeasurement), { headers: headers, withCredentials: true }).subscribe(function (data) {
                ...
                if (_this.msg[0] != 'Error') {
                    _this.unitOfMeasurementForm.reset();
    ...
    UnitOfMeasurementAddComponent.prototype.onDelete = function () {
        var _this = this;
    ...
    return UnitOfMeasurementAddComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('@flyInOutTrigger'),
    __metadata("design:type", Object)
], UnitOfMeasurementAddComponent.prototype, "flyInOutTrigger", void 0);
UnitOfMeasurementAddComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: ".m-grid__item.m-grid__item--fluid.m-wrapper",
        template: __webpack_require__("../../../../../src/app/theme/pages/inventory/unit-of-measurement/unit-of-measurement-add.component.html"),
...
var UnitOfMeasurementListComponent = (function () {
    function UnitOfMeasurementListComponent(_script, http, _router) {
        this._script = _script;
        this.http = http;
        this._router = _router;
        this.flyInOutTrigger = 'in';
    ...
    UnitOfMeasurementListComponent.prototype.ngAfterViewInit = function () {
    };
    UnitOfMeasurementListComponent.prototype.ngOnInit = function () {
        this.smart.smartUrl = sessionStorage.getItem('requestUrl') + "/axelacrm/inventory/uom-smartsearch";
        this.list.listUrl = sessionStorage.getItem('requestUrl') + "/axelacrm/inventory/uom-list"; //path should be changed
    };
    UnitOfMeasurementListComponent.prototype.toggleAnimation = function () {
        this._router.navigate(['inventory/unit-of-measurement-list/UOMadd'], { queryParams: { uomId: this.uomId } });
    };
    UnitOfMeasurementListComponent.prototype.smartClickListener = function (event) {
        this.list.listParam['requestType'] = 'filter';
        this.list.listParam['smartParam'] = event;
        this.list.getData();
    };
    UnitOfMeasurementListComponent.prototype.smartToggle = function () {
        if (this.smartHide) {
    ...
    UnitOfMeasurementListComponent.prototype.listClickListener = function (listParam) {
        if (listParam[0] == 'updateUOM') {
            this.uomId = listParam[1];
            this.toggleAnimation();
            //			this.unitOfMeasurementForm.reset();
        }
    };
    return UnitOfMeasurementListComponent;
}());
__decorate([
...
], UnitOfMeasurementListComponent.prototype, "smart", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["HostBinding"])('@flyInOutTrigger'),
    __metadata("design:type", Object)
], UnitOfMeasurementListComponent.prototype, "flyInOutTrigger", void 0);
__decorate([
...
], UnitOfMeasurementListComponent.prototype, "list", void 0);
__decorate([
...
], UnitOfMeasurementListComponent.prototype, "toast", void 0);
UnitOfMeasurementListComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: ".m-grid__item.m-grid__item--fluid.m-wrapper",
        template: __webpack_require__("../../../../../src/app/theme/pages/inventory/unit-of-measurement/unit-of-measurement-list.component.html"),
        encapsulation: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewEncapsulation"].None,
...
//# sourceMappingURL=unit-of-measurement-list.component.js.map

/***/ }),

/***/ "../../../../../src/app/theme/pages/inventory/unit-of-measurement/unit-of-measurement-list.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UnitOfMeasurementListModule", function() { return UnitOfMeasurementListModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__unit_of_measurement_list_component__ = __webpack_require__("../../../../../src/app/theme/pages/inventory/unit-of-measurement/unit-of-measurement-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__unit_of_measurement_add_component__ = __webpack_require__("../../../../../src/app/theme/pages/inventory/unit-of-measurement/unit-of-measurement-add.component.ts");
...
var routes = [
    {
        ...
        "children": [
            {
                "path": "",
                "component": __WEBPACK_IMPORTED_MODULE_0__unit_of_measurement_list_component__["a" /* UnitOfMeasurementListComponent */]
            }
        ]
    }, {
        "path": "UOMadd",
        ...
        "children": [
            {
                "path": "",
                "component": __WEBPACK_IMPORTED_MODULE_1__unit_of_measurement_add_component__["a" /* UnitOfMeasurementAddComponent */],
            }
        ]
    }
];
var UnitOfMeasurementListModule = (function () {
    function UnitOfMeasurementListModule() {
    }
    return UnitOfMeasurementListModule;
}());
UnitOfMeasurementListModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__angular_common__["CommonModule"], __WEBPACK_IMPORTED_MODULE_4__angular_router__["RouterModule"].forChild(routes), __WEBPACK_IMPORTED_MODULE_5__layouts_layout_module__["a" /* LayoutModule */], __WEBPACK_IMPORTED_MODULE_7__angular_common_http__["c" /* HttpClientModule */],
        ...
        declarations: [
            __WEBPACK_IMPORTED_MODULE_0__unit_of_measurement_list_component__["a" /* UnitOfMeasurementListComponent */], __WEBPACK_IMPORTED_MODULE_1__unit_of_measurement_add_component__["a" /* UnitOfMeasurementAddComponent */]
            //		,SmartSearchComponent
        ],
    })
], UnitOfMeasurementListModule);

//# sourceMappingURL=unit-of-measurement-list.module.js.map

/***/ })

});
//# sourceMappingURL=unit-of-measurement-list.module.chunk.js.map